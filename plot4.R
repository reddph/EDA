...
plot(tbase, filtHPC$Voltage, ylab="Voltage", type='l', xaxt="n", xlab="datetime")
axis(1, c(1,1439,2879), c("Thu","Fri","Sat"))
...
axis(1, c(1,1439,2879), c("Thu","Fri","Sat"))
legend.size <- legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(1,1,1),lwd=c(1.5,1.5,1.5),col=c("black","red","blue"),bty="n")
plot(tbase, filtHPC$Global_reactive_power, ylab="Global_reactive_power", type='l', xaxt="n", xlab="datetime")
axis(1, c(1,1439,2879), c("Thu","Fri","Sat"))
